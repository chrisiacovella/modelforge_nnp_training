...
if __name__ == "__main__":
    ...
    file_names = []
    experiments = {}
    for shift_energies in ["mean", "min", "max"]:
        for normalize in [False]:
            for initial_lr in [1e-3]:
                for potential_seed, dataset_set in [(123, 42), (124, 43), (125, 44)]:
                    ...
                    run_id = f"ps{potential_seed}_ds{dataset_set}_lr{initial_lr}_norm{str(normalize)}_shift{shift_energies}"
                    ...
                    training_parameters = {
                        ...
                        "group": "qm_schnet_normFalse",
                        "tags": [
                            "qm9",
                            "schnet",
                            "energy",
                            f"norm_{str(normalize)}",
                            f"shift_{shift_energies}",
                        ],
                    ...
                    loss_components = training_config_dict["training"][
                        "loss_parameter"
                    ]["loss_components"]
