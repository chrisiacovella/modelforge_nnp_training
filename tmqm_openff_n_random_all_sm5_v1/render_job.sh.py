...
if __name__ == "__main__":
    ...
    versions = [
        "sm_5_n_configs_1_random_all_v1.3",
        "sm_5_n_configs_2_random_all_v1.3",
        "sm_5_n_configs_5_random_all_v1.3",
        "sm_5_n_configs_10_random_all_v1.3",
        "sm_5_n_configs_20_random_all_v1.3",
        "sm_5_n_configs_30_random_all_v1.3",
        "sm_5_n_configs_40_random_all_v1.3",
    ]
    ...
    for version_select in versions:
        for potential_seed, dataset_set in [(123, 42), (124, 43), (125, 44)]:
            ...
            training_parameters = {
                ...
                "group": f"{dataset_name}_{potential_name}_n_random_all_sm5_v1",
                "tags": [
                    f"{dataset_name}",
                    f"{potential_name}",
                    f"{version_select}",
