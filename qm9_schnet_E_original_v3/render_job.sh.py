...
if __name__ == "__main__":
    ...
    for normalize in [True]:
        for split_val, split_test in [[0.0074691, 0.16747955], [0.074691, 0.10025768]]:
            for initial_lr in [1e-3, 5e-4]:
                for potential_seed, dataset_set in [(123, 42), (124, 43), (125, 44)]:
                    ...
                    run_id = f"ps{potential_seed}_ds{dataset_set}_lr{initial_lr}_norm{str(normalize)}_split_val{str(split_val)}_split_test{str(split_test)}"
