...
if __name__ == "__main__":
    ...
    for normalize in [True, False]:
        for initial_lr in [5e-3, 1e-3, 8e-4, 5e-4, 1e-4]:
            for potential_seed, dataset_set in [(123, 42), (124, 43), (125, 44)]:
                ...
                run_id = f"ps{potential_seed}_ds{dataset_set}_norm{str(normalize)}_lr{initial_lr}"
                ...
                training_parameters = {
                    ...
                    "group": "qm_schnet_norm_compare",
                    "tags": ["qm9", "schnet", "energy", f"norm_{str(normalize)}"],
