...
if __name__ == "__main__":
    ...
    for lr_scheduler_threshold in [0.01, 0.001]:
        for normalize in [True]:
            for force_loss_weight in [0.001, 0.0001, 0.00001]:
                for initial_lr in [1e-4, 5e-4]:
                    for potential_seed, dataset_set in [(123, 42), (124, 43), (125, 44)]:
                        ...
                        run_id = f"ps{potential_seed}_ds{dataset_set}_lr{initial_lr}_norm{str(normalize)}_force_{str(force_loss_weight)}_threshold{str(lr_scheduler_threshold)}"
                        ...
                        training_parameters = {
                            ...
                            "project": "qm9_schnet_original_E_F_v3",
