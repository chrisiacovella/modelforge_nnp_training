...
if __name__ == "__main__":
    ...
    for normalize in [True]:
        for radial_basis_functions in [64, 128]:
            for initial_lr in [5e-4, 2e-3, 1e-3, 5e-4, 1e-4]:
                for potential_seed, dataset_set in [(123, 42), (124, 43), (125, 44)]:
                    ...
                    run_id = f"ps{potential_seed}_ds{dataset_set}_lr{initial_lr}_norm{str(normalize)}_rbf{str(radial_basis_functions)}"
                    ...
                    potential_parameters = {
                        ...
                        "normalize": normalize,
                        "radial_basis_functions": radial_basis_functions
