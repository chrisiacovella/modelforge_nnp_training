...
if __name__ == "__main__":
    ...
    for normalize in [True]:
        for force_loss_weight in [1,0.1, 0.01, 0.001]:
            for initial_lr in [5e-4]:
                for potential_seed, dataset_set in [(123, 42), (124, 43), (125, 44), (126,45)]:
                    ...
                    run_id = f"ps{potential_seed}_ds{dataset_set}_lr{initial_lr}_norm{str(normalize)}_force_{str(force_loss_weight)}"
                    ...
                    training_parameters = {
                        ...
                        "tags": ["qm9", "schnet", "energy", f"norm_{str(normalize)}", "force_{str(force_loss_weight)}", f"lr_{str(initial_lr)}"],
                        "notes": f"{run_id}; training of {potential_name} on {dataset_name} with energy and force with loss {force_loss_weight}",
