...
if __name__ == "__main__":
    ...
    versions = [
        "sm_1_n_configs_1_start_overlap_v1.3",
        "sm_1_n_configs_2_start_overlap_v1.3",
        "sm_1_n_configs_5_start_overlap_v1.3",
        "sm_1_n_configs_10_start_overlap_v1.3",
        "sm_1_n_configs_20_start_overlap_v1.3",
        "sm_1_n_configs_30_start_overlap_v1.3",
        "sm_1_n_configs_40_start_overlap_v1.3",
    ]
    ...
    for version_select in versions:
        for potential_seed, dataset_set in [(123, 42), (124, 43), (125, 44)]:
            ...
            run_id = f"{version_select}_ps{potential_seed}_ds{dataset_set}"
            ...
            training_parameters = {
                ...
                "group": f"{dataset_name}_{potential_name}_start_overlap",
                "tags": [
                    f"{dataset_name}",
                    f"{potential_name}",
